...
<%@ include file="../header.jsp" %>  
		<div class="contentbody">
			<div class="body1 join">
				<form method="post" class="join_form" action="join" name="formm">
                <table id="joinTb">
                  <tr><td colspan="3"><h1>회원가입</h1></td></tr>
                  <tr>
                    <td class="space"></td>
                    <th>아이디</th>
                    <td>
                      <input type="text" name="id" placeholder="영어/숫자 4자 이상" class="inputBox">
                      <input type="hidden" name="reid" class="inputBox">
                      <input type="button" value="중복확인" class="inputBox" onclick="idcheck_form()">
                    </td>
                  </tr>
                  <tr>
                    <td class="space"></td>
                  ...
                  <tr>
                    <td class="space"></td>
                    <th>비밀번호 확인</th>
                    <td><input type="password" name="pwdCheck" placeholder="영문/숫자포함 6자 이상" class="inputBox"></td>
                  </tr>
                  <tr>
                    <td class="space"></td>
                    <th> 이름</th>
                  ...
                  <tr>
                    ...
                    <th> 생년월일</th>
                    <td>
                      <input type="text" name="birth" id="birthpicker" class="inputBox"> 
                    </td>
                  </tr>
                  <tr>
                    <td class="space"></td>
				...
				<table id="col">
					<tr>
						<td><a href='#'><input type="button" value="회원가입" class="coll coll1" onclick="go_save()"></a></td>
						<td><a href='#'><input type="reset" value="취소" class="coll"></a></td>
					</tr>
				</table>
				</form>
			</div>
