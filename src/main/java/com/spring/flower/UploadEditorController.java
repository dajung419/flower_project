...
public class UploadEditorController {
	...
	@ResponseBody
	@RequestMapping(value = "/uploadEditorForm", method = {RequestMethod.GET, RequestMethod.POST}, produces = "text/plain;charset=UTF-8")
	public ResponseEntity<String> uploadForm(
		...
		url += "&sFileURL=/flower/displayEditorFile/" + uploadedName;
		...
		ResponseEntity<String> result = new ResponseEntity<String>(url, HttpStatus.OK);
		return result;
