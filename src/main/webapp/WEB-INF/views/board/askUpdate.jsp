      ...
      <form  method="post" name="formm" action="ask_update">  
        ...
        <table id="review_table">
            ...
            <tr>
                ...
                <td>
                	<input type="hidden" id="cate"value="${askVO.q_category }">
                	<select class="input_title" id="category" name="q_category" >
            ...
            <tr>
                ...
                <td colspan="3">
                	<input type="text" class="input_title" name="q_title" value="${askVO.q_title }">
                </td>
            </tr>
            <tr>
                <td colspan="4" class="paddingZone">&ensp;
                	<textarea name="q_contents" id="q_contents" rows="20" cols="130">${askVO.q_contents }</textarea>
                </td>
            </tr>
